...
export default function BottomInfobar() {
    ...
    return (
        <>
            <div className="h-min flex justify-between bg-darkgray p-1 px-3">
                ...
                <div className="w-full my-auto flex justify-center gap-0 font-bold align-text-bottom">
                    <input
                        ...
                        className="w-min ring-0 outline-0 m-auto text-center"
                ...
                <div className="w-full my-auto flex justify-end gap-2 font-bold">
